...
pixel_values: torch.Tensor = load_image('/Users/jrp/Pictures/Processed/20241227-113523_DSC01174.jpg', max_num=12).to(torch.bfloat16).to('mps')
...
pixel_values1: torch.Tensor = load_image('/Users/jrp/Pictures/Processed/20241227-113523_DSC01174.jpg', max_num=12).to(torch.bfloat16).mps()
pixel_values2: torch.Tensor = load_image('/Users/jrp/Pictures/Processed/20241227-115016_DSC01188.jpg', max_num=12).to(torch.bfloat16).mps()
...
pixel_values1 = load_image('/Users/jrp/Pictures/Processed/20241227-113523_DSC01174.jpg', max_num=12).to(torch.bfloat16).mps()
pixel_values2 = load_image('/Users/jrp/Pictures/Processed/20241227-115016_DSC01188.jpg', max_num=12).to(torch.bfloat16).mps()
...
responses: List[str] = model.batch_chat(tokenizer, pixel_values,
                             num_patches_list=num_patches_list,
                             questions=questions,
