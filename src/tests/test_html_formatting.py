...
def test_escape_html_tags_selective_basic() -> None:
    ...
    result = check_models._escape_html_tags_selective("Use <model> here")
...
def test_escape_html_tags_selective_multiple() -> None:
    ...
    text = "<a> and <b> tags"
    result = check_models._escape_html_tags_selective(text)
...
def test_escape_html_tags_selective_preserves_entities() -> None:
    ...
    result = check_models._escape_html_tags_selective("5 &lt; 10")
    assert result == "5 &lt; 10"
...
def test_escape_html_tags_selective_mixed() -> None:
    ...
    result = check_models._escape_html_tags_selective("5 < 10 &amp; 10 > 5")
...
def test_escape_html_tags_selective_ampersands() -> None:
    ...
    result = check_models._escape_html_tags_selective("Tom & Jerry")
...
def test_escape_html_tags_selective_empty() -> None:
    ...
    assert check_models._escape_html_tags_selective("") == ""


def test_escape_html_tags_selective_entity_chain() -> None:
    """Should preserve complex entity chains."""
    result = check_models._escape_html_tags_selective("&lt;&gt; &amp; &quot;")
    assert "&lt;" in result
    assert "&gt;" in result
    assert "&amp;" in result
    assert "&quot;" in result
