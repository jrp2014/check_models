...
- `mlx-community/Qwen3.5-35B-A3B-bf16`: `cutoff` | token_cap, missing_sections, repetitive_tail, trusted_overlap, instruction_markers, reasoning_leak | Inspect token cap and stop behavior before treating this as a model-quality failure.

### `mlx-vlm`

- `mlx-community/LFM2-VL-1.6B-8bit`: `harness` | harness:stop_token, trusted_overlap, instruction_markers, metadata_terms, reasoning_leak, context_echo, fabrication | Inspect prompt-template, stop-token, and decode post-processing behavior.
...
- `mlx-community/Molmo-7B-D-0924-8bit`: `cutoff` | token_cap, missing_sections, repetitive_tail, abrupt_tail, utility_delta_negative, degeneration | Inspect token cap and stop behavior before treating this as a model-quality failure.
...
- `mlx-community/FastVLM-0.5B-bf16`: `harness` | model_error, transformers_model_load_model | Inspect upstream template/tokenizer/config compatibility.
...
- `mlx-community/FastVLM-0.5B-bf16`: `harness` | preserves trusted hints | model_error, transformers_model_load_model
- `mlx-community/LFM2-VL-1.6B-8bit`: `harness` | preserves trusted hints | harness:stop_token, trusted_overlap, instruction_markers, metadata_terms, reasoning_leak, context_echo, fabrication
- `mlx-community/LFM2.5-VL-1.6B-bf16`: `harness` | preserves trusted hints | harness:stop_token, trusted_overlap, instruction_markers, metadata_terms, reasoning_leak, context_echo, fabrication
...
- `mlx-community/Molmo-7B-D-0924-8bit`: `cutoff` | degrades trusted hints | token_cap, missing_sections, repetitive_tail, abrupt_tail, utility_delta_negative, degeneration
...
- **Verdict:** cutoff | user=avoid
- **Why:** token_cap, missing_sections, repetitive_tail, abrupt_tail, utility_delta_negative, degeneration
