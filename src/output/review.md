...
| `mlx-community/Molmo-7B-D-0924-8bit` | `model_shortcoming` | ignores trusted hints \| missing terms: Town, Centre, Alton, United, Kingdom | nontext prompt burden=76% \| missing sections: title, description, keywords \| missing terms: Town, Centre, Alton, United, Kingdom |
...
| `mlx-community/Molmo-7B-D-0924-bf16` | `cutoff` | ignores trusted hints \| missing terms: Town, Centre, Alton, United, Kingdom | hit token cap (500) \| output/prompt=30.54% \| nontext prompt burden=76% \| missing sections: title, description, keywords |
...
| `mlx-community/Molmo-7B-D-0924-8bit` | `model_shortcoming` | nontext prompt burden=76% \| missing sections: title, description, keywords \| missing terms: Town, Centre, Alton, United, Kingdom | Treat as a model limitation for this prompt; the requested output contract is not being met. |
...
| `mlx-community/Molmo-7B-D-0924-bf16` | `cutoff` | hit token cap (500) \| output/prompt=30.54% \| nontext prompt burden=76% \| missing sections: title, description, keywords | Raise the token cap or trim prompt burden first; generation hit the limit while title, description, keywords remained incomplete. |
...
- **Utility:** user=avoid | ignores trusted hints
- **Stack / owner:** owner=model
- **Token accounting:** prompt=1637 | text_est=387 | nontext_est=1250 | gen=165 | max=500 | stop=completed
- **Next action:** Treat as a model limitation for this prompt; the requested output contract is not being met.
...
- **Verdict:** cutoff | user=avoid
- **Why:** hit token cap (500) | output/prompt=30.54% | nontext prompt burden=76% | missing sections: title, description, keywords
- **Trusted hints:** ignores trusted hints | missing terms: Town, Centre, Alton, United, Kingdom
- **Contract:** missing: title, description, keywords
- **Utility:** user=avoid | ignores trusted hints
- **Stack / owner:** owner=model
- **Token accounting:** prompt=1637 | text_est=387 | nontext_est=1250 | gen=500 | max=500 | stop=completed
- **Next action:** Raise the token cap or trim prompt burden first; generation hit the limit while title, description, keywords remained incomplete.
