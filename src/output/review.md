...
| `mlx-community/Molmo-7B-D-0924-8bit` | `cutoff` | degrades trusted hints \| nonvisual metadata reused | hit token cap (500) \| output/prompt=29.92% \| nontext prompt burden=75% \| missing sections: title, description, keywords |
...
| `mlx-community/Molmo-7B-D-0924-8bit` | `cutoff` | hit token cap (500) \| output/prompt=29.92% \| nontext prompt burden=75% \| missing sections: title, description, keywords | Raise the token cap or trim prompt burden first; generation hit the limit while title, description, keywords remained incomplete. |
...
- **Verdict:** cutoff | user=avoid
- **Why:** hit token cap (500) | output/prompt=29.92% | nontext prompt burden=75% | missing sections: title, description, keywords
...
- **Stack / owner:** owner=model
- **Token accounting:** prompt=1671 | text_est=424 | nontext_est=1247 | gen=500 | max=500 | stop=completed
- **Next action:** Raise the token cap or trim prompt burden first; generation hit the limit while title, description, keywords remained incomplete.
...
- **Verdict:** cutoff | user=avoid
- **Why:** hit token cap (500) | output/prompt=66.31% | missing sections: title, description, keywords | missing terms: flies, low, over, tranquil, style
- **Trusted hints:** preserves trusted hints | nonvisual metadata reused
- **Contract:** missing: title, description, keywords
- **Utility:** user=avoid | preserves trusted hints | metadata borrowing
- **Stack / owner:** owner=model
- **Token accounting:** prompt=754 | text_est=424 | nontext_est=330 | gen=500 | max=500 | stop=completed
- **Next action:** Raise the token cap or trim prompt burden first; generation hit the limit while title, description, keywords remained incomplete.
