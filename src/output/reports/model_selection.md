...
| `mlx-community/diffusiongemma-26B-A4B-it-8bit`     |       100 |           96 | `clean`   | A high-angle shot shows two tabby cats lying down on a pink blanket on a red couch next to two remote controls.                                                                     | nontext prompt burden=98% |
...
| `mlx-community/diffusiongemma-26B-A4B-it-mxfp8`    |       100 |           92 | `clean`   | The image shows two tabby cats sleeping on a pink blanket next to two remote controls.                                                                                              | nontext prompt burden=98% |
