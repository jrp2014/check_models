...
| `mlx-community/diffusiongemma-26B-A4B-it-8bit`     |       100 |           96 | `clean`   | A high-angle shot shows two tabby cats sleeping on a pink blanket on a red couch, with two remote controls lying near them.                                                         | nontext prompt burden=98% |
...
| `mlx-community/diffusiongemma-26B-A4B-it-mxfp8`    |       100 |           93 | `clean`   | A high-angle shot shows two tabby cats sleeping on a pink blanket next to two remote controls.                                                                                      | nontext prompt burden=98% |
