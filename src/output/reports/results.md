...
- _Phase totals:_ model load=109.55s, local prompt prep=0.16s, upstream
  prefill / first-token=664.33s, post-prefill decode=478.53s, generation total
  (unsplit)=3.66s, cleanup=6.17s.
- _Generation total:_ 1146.53s across 51 model(s); upstream prefill /
...
- _Validation overhead:_ 11.46s total (avg 0.21s across 55 model(s)).
- _Upstream prefill / first-token latency:_ Avg 13.84s | Min 0.09s | Max
  85.19s across 48 model(s).

## 🏆 Performance Highlights

- **Fastest:** `mlx-community/FastVLM-0.5B-bf16` (347.0 tps)
- **💾 Most efficient:** `mlx-community/FastVLM-0.5B-bf16` (2.2 GB)
- **⚡ Fastest load:** `mlx-community/nanoLLaVA-1.5-4bit` (0.49s)
- **📊 Average TPS:** 67.6 across 48 models
...
- **Generation Tps**: Avg: 67.6 | Min: 4.73 | Max: 347
- **Peak Memory**: Avg: 21 | Min: 2.2 | Max: 78
- **Total Time**: Avg: 26.12s | Min: 1.40s | Max: 121.18s
- **Generation Time**: Avg: 23.81s | Min: 0.70s | Max: 117.73s
- **Model Load Time**: Avg: 2.09s | Min: 0.49s | Max: 8.90s
...
- _Best descriptions:_ [`mlx-community/Ministral-3-14B-Instruct-2512-nvfp4`](https://github.com/jrp2014/check_models/blob/main/src/output/reports/model_gallery.md#model-mlx-community-ministral-3-14b-instruct-2512-nvfp4)
  (Utility A 86/100 | Description 93 | Keywords 86 | Speed 62.6 TPS | Memory
...
- _Fastest generation:_ [`mlx-community/FastVLM-0.5B-bf16`](https://github.com/jrp2014/check_models/blob/main/src/output/reports/model_gallery.md#model-mlx-community-fastvlm-05b-bf16)
  (Utility D 45/100 | Description 70 | Keywords 0 | Speed 347 TPS | Memory 2.2
...
| `mlx-community/ERNIE-4.5-VL-28B-A3B-Thinking-bf16`      |                   |                       |                |              |           |             |            1.46s |      5.17s |       7.05s | hallucination, fabrication, ... |         mlx-vlm |
| `mlx-community/Kimi-VL-A3B-Thinking-8bit`               |                   |                       |                |              |           |             |                  |      0.41s |       1.40s |                                 |             mlx |
| `mlx-community/LFM2-VL-1.6B-8bit`                       |                   |                       |                |              |           |             |            1.10s |      0.57s |       1.88s | ⚠️harness(stop_token), ...      |         mlx-vlm |
| `mlx-community/LFM2.5-VL-1.6B-bf16`                     |                   |                       |                |              |           |             |            1.09s |      0.55s |       1.85s | ⚠️harness(stop_token), ...      |         mlx-vlm |
| `mlx-community/MolmoPoint-8B-fp16`                      |                   |                       |                |              |           |             |                  |      2.32s |       3.62s |                                 |    model-config |
| `mlx-community/nanoLLaVA-1.5-4bit`                      |               513 |                    90 |            603 |        5,931 |       322 |         2.6 |            0.70s |      0.49s |       1.40s | missing-sections(keywords), ... |                 |
| `qnguyen3/nanoLLaVA`                                    |               513 |                    64 |            577 |        4,661 |       112 |         4.7 |            1.01s |      0.76s |       1.97s | missing-sections(keywords)      |                 |
| `mlx-community/FastVLM-0.5B-bf16`                       |               517 |                   181 |            698 |        5,141 |       347 |         2.2 |            1.08s |      0.60s |       1.89s | fabrication, ...                |                 |
| `HuggingFaceTB/SmolVLM-Instruct`                        |             2,087 |                    70 |          2,157 |        3,998 |       123 |         5.8 |            1.52s |      0.61s |       2.34s | missing-sections(title+desc...  |                 |
| `mlx-community/SmolVLM-Instruct-bf16`                   |             2,087 |                    70 |          2,157 |        3,403 |       116 |         5.8 |            1.67s |      0.64s |       2.53s | missing-sections(title+desc...  |                 |
| `mlx-community/gemma-4-26b-a4b-it-4bit`                 |               784 |                    89 |            873 |        1,485 |       104 |          17 |            1.72s |      2.47s |       4.43s |                                 |                 |
| `mlx-community/SmolVLM2-2.2B-Instruct-mlx`              |               623 |                   137 |            760 |        1,387 |       121 |         5.8 |            2.02s |      0.60s |       2.83s | fabrication, ...                |                 |
| `mlx-community/paligemma2-10b-ft-docci-448-6bit`        |             1,538 |                    31 |          1,569 |        1,364 |      31.4 |          12 |            2.46s |      1.64s |       4.32s | missing-sections(title+desc...  |                 |
| `mlx-community/Ministral-3-3B-Instruct-2512-4bit`       |             4,114 |                   127 |          4,241 |        2,276 |       182 |          13 |            2.88s |      0.93s |       4.02s |                                 |                 |
| `mlx-community/llava-v1.6-mistral-7b-8bit`              |             3,503 |                    20 |          3,523 |        1,422 |        60 |         9.7 |            3.23s |      1.06s |       4.49s | missing-sections(title+desc...  |                 |
| `mlx-community/InternVL3-8B-bf16`                       |             3,064 |                    87 |          3,151 |        2,831 |      34.4 |          18 |            3.98s |      1.76s |       5.95s |                                 |                 |
| `mlx-community/gemma-3n-E2B-4bit`                       |               774 |                   500 |          1,274 |        2,342 |       111 |           6 |            5.13s |      1.58s |       6.93s | repetitive(phrase: "18:33:4...  |                 |
| `mlx-community/gemma-4-31b-it-4bit`                     |               784 |                    88 |            872 |          514 |      26.4 |          20 |            5.20s |      2.74s |       8.15s |                                 |                 |
| `meta-llama/Llama-3.2-11B-Vision-Instruct`              |               484 |                    17 |            501 |          263 |      5.45 |          25 |            5.28s |      2.31s |       7.81s | missing-sections(title+desc...  |                 |
| `mlx-community/Ministral-3-14B-Instruct-2512-mxfp4`     |             4,115 |                   114 |          4,229 |        1,258 |      65.8 |          18 |            5.37s |      1.38s |       6.97s |                                 |                 |
| `mlx-community/Idefics3-8B-Llama3-bf16`                 |             3,507 |                   117 |          3,624 |        2,454 |      32.4 |          20 |            5.46s |      1.95s |       7.61s | description-sentences(3), ...   |                 |
| `mlx-community/Ministral-3-14B-Instruct-2512-nvfp4`     |             4,115 |                   118 |          4,233 |        1,254 |      62.6 |          19 |            5.54s |      1.46s |       7.21s |                                 |                 |
| `mlx-community/gemma-3-27b-it-qat-4bit`                 |               783 |                   113 |            896 |          569 |      27.3 |          19 |            5.84s |      2.59s |       8.65s | keyword-count(19)               |                 |
| `mlx-community/InternVL3-14B-8bit`                      |             3,064 |                   120 |          3,184 |        1,213 |      31.7 |          19 |            6.68s |      1.81s |       8.70s | description-sentences(3), ...   |                 |
| `mlx-community/gemma-3n-E4B-it-bf16`                    |               782 |                   266 |          1,048 |        1,640 |      43.9 |          17 |            6.85s |      2.35s |       9.42s | missing-sections(title+desc...  |                 |
| `mlx-community/pixtral-12b-8bit`                        |             4,662 |                   135 |          4,797 |        1,456 |      37.9 |          18 |            7.13s |      1.70s |       9.05s | description-sentences(3), ...   |                 |
| `mlx-community/Llama-3.2-11B-Vision-Instruct-8bit`      |               483 |                   119 |            602 |          304 |      21.9 |          15 |            7.31s |      1.47s |       8.98s | missing-sections(title+desc...  |                 |
| `mlx-community/paligemma2-10b-ft-docci-448-bf16`        |             1,538 |                    31 |          1,569 |        1,043 |      5.25 |          27 |            7.75s |      2.42s |      10.38s | missing-sections(title+desc...  |                 |
| `mlx-community/gemma-3-27b-it-qat-8bit`                 |               783 |                   104 |            887 |          509 |      15.6 |          33 |            8.52s |      3.46s |      12.20s |                                 |                 |
| `jqlive/Kimi-VL-A3B-Thinking-2506-6bit`                 |             1,516 |                   490 |          2,006 |        1,633 |      67.9 |          18 |            8.56s |      1.94s |      10.71s | missing-sections(title), ...    |                 |
| `mlx-community/pixtral-12b-bf16`                        |             4,662 |                   138 |          4,800 |        1,921 |      20.4 |          28 |            9.53s |      2.89s |      12.64s | description-sentences(3), ...   |                 |
| `mlx-community/Phi-3.5-vision-instruct-bf16`            |             1,337 |                   500 |          1,837 |        3,914 |      55.6 |         9.5 |            9.62s |      0.86s |      10.69s | repetitive(phrase: "flags,...   |                 |
| `mlx-community/Devstral-Small-2-24B-Instruct-2512-5bit` |             3,619 |                   108 |          3,727 |          634 |      29.9 |          27 |            9.72s |      2.18s |      12.15s | ⚠️harness(encoding), ...        |                 |
| `microsoft/Phi-3.5-vision-instruct`                     |             1,337 |                   500 |          1,837 |        3,765 |      55.2 |         9.5 |            9.73s |      0.92s |      10.89s | repetitive(phrase: "flags,...   |                 |
| `mlx-community/paligemma2-3b-pt-896-4bit`               |             4,610 |                   500 |          5,110 |        3,551 |        47 |         4.6 |           12.48s |      1.23s |      13.93s | repetitive(phrase: "- outpu...  |                 |
| `mlx-community/GLM-4.6V-Flash-mxfp4`                    |             6,570 |                   500 |          7,070 |        1,132 |      68.7 |         8.4 |           13.39s |      1.30s |      14.89s | missing-sections(title+keyw...  |                 |
| `mlx-community/Molmo-7B-D-0924-8bit`                    |             1,468 |                   138 |          1,606 |          138 |      52.1 |          29 |           13.79s |      1.20s |      15.21s | missing-sections(title+desc...  |                 |
| `mlx-community/GLM-4.6V-Flash-6bit`                     |             6,570 |                   500 |          7,070 |        1,163 |      54.4 |          11 |           15.14s |      1.37s |      16.73s | missing-sections(title+desc...  |                 |
| `mlx-community/Apriel-1.5-15b-Thinker-6bit-MLX`         |             4,753 |                   500 |          5,253 |        1,456 |      39.2 |          15 |           16.39s |      1.72s |      18.34s | missing-sections(title+desc...  |                 |
| `mlx-community/GLM-4.6V-nvfp4`                          |             6,570 |                   500 |          7,070 |          548 |      36.8 |          78 |           25.90s |      5.52s |      31.65s | missing-sections(title+desc...  |                 |
| `mlx-community/paligemma2-3b-ft-docci-448-bf16`         |             1,538 |                   500 |          2,038 |        3,288 |      18.9 |          11 |           27.31s |      1.54s |      29.06s | repetitive(phrase: "the ima...  |                 |
| `mlx-community/Molmo-7B-D-0924-bf16`                    |             1,468 |                   500 |          1,968 |          134 |      30.3 |          36 |           27.94s |      1.90s |      30.04s | missing-sections(title+desc...  |                 |
| `mlx-community/X-Reasoner-7B-8bit`                      |            16,901 |                   500 |         17,401 |          835 |      47.5 |          14 |           31.36s |      1.18s |      32.76s | description-sentences(3), ...   |                 |
| `mlx-community/Qwen3.5-9B-MLX-4bit`                     |            16,916 |                   500 |         17,416 |          307 |      86.6 |          12 |           61.45s |      1.41s |      63.09s | missing-sections(title+desc...  |                 |
| `mlx-community/Qwen2-VL-2B-Instruct-4bit`               |            16,901 |                    11 |         16,912 |          262 |       186 |         5.1 |           65.09s |      0.67s |      65.98s | ⚠️harness(long_context), ...    |                 |
| `mlx-community/Qwen3.5-35B-A3B-4bit`                    |            16,916 |                   500 |         17,416 |          276 |      94.6 |          26 |           67.17s |      3.47s |      70.86s | missing-sections(descriptio...  |                 |
| `mlx-community/Qwen3.5-35B-A3B-6bit`                    |            16,916 |                   500 |         17,416 |          277 |      79.4 |          35 |           68.11s |      3.20s |      71.53s | missing-sections(title+desc...  |                 |
| `mlx-community/Qwen3.5-35B-A3B-bf16`                    |            16,916 |                   500 |         17,416 |          261 |      62.3 |          76 |           73.63s |      8.90s |      82.74s | missing-sections(title+desc...  |                 |
| `mlx-community/gemma-4-31b-bf16`                        |               772 |                   500 |          1,272 |          222 |      7.11 |          64 |           74.20s |      6.25s |      80.67s | missing-sections(title+desc...  |                 |
| `mlx-community/Kimi-VL-A3B-Thinking-2506-bf16`          |             1,516 |                   351 |          1,867 |        1,057 |      4.73 |          39 |           76.17s |      3.26s |      79.65s | missing-sections(title), ...    |                 |
| `mlx-community/Qwen3.5-27B-4bit`                        |            16,916 |                   500 |         17,416 |          213 |      26.2 |          26 |           99.15s |      2.23s |     101.61s | refusal(explicit_refusal), ...  |                 |
| `mlx-community/Qwen3.6-27B-mxfp8`                       |            16,916 |                   500 |         17,416 |          225 |      17.2 |          39 |          104.98s |      3.11s |     108.32s | title-length(4), ...            |                 |
| `mlx-community/Qwen3.5-27B-mxfp8`                       |            16,916 |                   500 |         17,416 |          199 |      15.7 |          39 |          117.73s |      3.22s |     121.18s | keyword-count(20), ...          |                 |
...
_Report generated on: 2026-05-08 22:16:24 BST_
