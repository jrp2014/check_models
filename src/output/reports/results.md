...
- _Quality signal frequency:_ low_draft_improvement=40, missing_sections=22,
  keyword_count=19, cutoff=14, context_ignored=11, trusted_hint_ignored=11.
...
- _❌ Failed Models (1):_ [`mlx-community/gemma-4-31b-bf16`](https://github.com/jrp2014/check_models/blob/main/src/output/reports/model_gallery.md#model-mlx-community-gemma-4-31b-bf16).
  Example: `Model Error`.
- _🔄 Repetitive Output (9):_ [`Qwen/Qwen3-VL-2B-Instruct`](https://github.com/jrp2014/check_models/blob/main/src/output/reports/model_gallery.md#model-qwen-qwen3-vl-2b-instruct),
...
|-----------|------------|---------------|----------------------------------|
| `mlx`     |          1 | Model Error   | `mlx-community/gemma-4-31b-bf16` |
...
|:--------------------------------------------------------|------------------:|----------------------:|---------------:|----------:|------------:|:----------------|-----------------:|-----------:|------------:|:-----------------------------------|----------------:|
| `mlx-community/gemma-4-31b-bf16`                        |                   |                       |                |           |             |                 |          117.72s |     17.87s |     135.96s | gibberish(char_noise), ...         |             mlx |
| `LiquidAI/LFM2.5-VL-450M-MLX-bf16`                      |               639 |                   181 |            820 |       504 |         1.4 | stop            |            0.81s |      0.38s |       1.55s | title-length(30), ...              |                 |
| `mlx-community/LFM2-VL-1.6B-8bit`                       |               829 |                   144 |            973 |       331 |           3 | stop            |            0.99s |      0.54s |       1.91s | title-length(17), ...              |                 |
| `qnguyen3/nanoLLaVA`                                    |               562 |                    37 |            599 |       113 |         5.1 | stop            |            1.00s |      0.70s |       2.06s | missing-sections(keywords), ...    |                 |
| `mlx-community/nanoLLaVA-1.5-4bit`                      |               562 |                    98 |            660 |       192 |         2.8 | stop            |            1.15s |      0.67s |       2.18s | keyword-count(21), ...             |                 |
| `HuggingFaceTB/SmolVLM-Instruct`                        |             1,776 |                    18 |          1,794 |       127 |         5.6 | stop            |            1.22s |      0.68s |       2.27s | missing-sections(title+desc...     |                 |
| `mlx-community/MiniCPM-V-4.6-8bit`                      |             1,179 |                    81 |          1,260 |       181 |           4 | stop            |            1.36s |      0.94s |       2.69s | ⚠️harness(stop_token), ...         |                 |
| `mlx-community/FastVLM-0.5B-bf16`                       |               566 |                   171 |            737 |       292 |         2.2 | stop            |            1.70s |      0.87s |       2.95s | keyword-count(28), ...             |                 |
| `mlx-community/paligemma2-10b-ft-docci-448-6bit`        |             1,582 |                    17 |          1,599 |      30.5 |          12 | stop            |            2.27s |      1.62s |       4.25s | missing-sections(title+desc...     |                 |
| `mlx-community/gemma-4-26b-a4b-it-4bit`                 |               835 |                    86 |            921 |      56.7 |          18 | stop            |            2.69s |      2.51s |       5.57s |                                    |                 |
| `microsoft/Phi-3.5-vision-instruct`                     |             1,394 |                   130 |          1,524 |      57.6 |         9.5 | stop            |            3.08s |      1.21s |       4.65s | keyword-count(21), ...             |                 |
| `mlx-community/LFM2.5-VL-1.6B-bf16`                     |               829 |                   500 |          1,329 |       175 |         4.1 | length          |            3.41s |      0.59s |       4.37s | repetitive(phrase: "boating...     |                 |
| `mlx-community/InternVL3-8B-bf16`                       |             2,345 |                    81 |          2,426 |      35.3 |          18 | stop            |            3.79s |      1.66s |       5.82s | low-draft-improvement              |                 |
| `mlx-community/Ministral-3-14B-Instruct-2512-mxfp4`     |             3,173 |                   105 |          3,278 |      66.1 |          13 | stop            |            4.38s |      1.51s |       6.26s |                                    |                 |
| `mlx-community/pixtral-12b-8bit`                        |             3,366 |                    92 |          3,458 |      39.4 |          16 | stop            |            4.67s |      1.99s |       7.02s | low-draft-improvement              |                 |
| `mlx-community/paligemma2-10b-ft-docci-448-bf16`        |             1,582 |                    17 |          1,599 |      5.63 |          26 | stop            |            4.98s |      2.47s |       7.83s | missing-sections(title+desc...     |                 |
| `mlx-community/Idefics3-8B-Llama3-bf16`                 |             2,855 |                   109 |          2,964 |      33.3 |          19 | stop            |            5.12s |      2.14s |       7.64s | title-length(11), ...              |                 |
| `mlx-community/diffusiongemma-26B-A4B-it-8bit`          |               835 |                    89 |            924 |      20.6 |          29 | stop            |            5.45s |      3.46s |       9.35s | low-draft-improvement              |                 |
| `mlx-community/Ministral-3-3B-Instruct-2512-4bit`       |             3,172 |                   125 |          3,297 |      64.9 |         7.8 | stop            |            5.74s |      1.36s |       7.66s | description-sentences(3)           |                 |
| `mlx-community/SmolVLM-Instruct-bf16`                   |             1,776 |                    18 |          1,794 |      38.6 |         5.7 | stop            |            6.32s |      1.54s |      10.10s | missing-sections(title+desc...     |                 |
| `mlx-community/SmolVLM2-2.2B-Instruct-mlx`              |               676 |                   275 |            951 |       120 |         5.5 | stop            |            6.33s |      1.47s |       9.98s | keyword-count(56), ...             |                 |
| `mlx-community/pixtral-12b-bf16`                        |             3,366 |                    88 |          3,454 |      20.7 |          28 | stop            |            6.52s |      2.79s |       9.67s | low-draft-improvement              |                 |
| `mlx-community/Ministral-3-14B-Instruct-2512-nvfp4`     |             3,173 |                   108 |          3,281 |      26.5 |          13 | stop            |            6.90s |      1.58s |       8.86s |                                    |                 |
| `mlx-community/gemma-4-31b-it-4bit`                     |               835 |                    90 |            925 |      19.6 |          22 | stop            |            6.91s |      2.70s |       9.98s | low-draft-improvement              |                 |
| `mlx-community/InternVL3-14B-8bit`                      |             2,345 |                   109 |          2,454 |      23.6 |          18 | stop            |            6.91s |      1.76s |       9.05s | low-draft-improvement              |                 |
| `mlx-community/Devstral-Small-2-24B-Instruct-2512-5bit` |             2,640 |                    96 |          2,736 |      30.4 |          23 | stop            |            7.00s |      2.31s |       9.70s | title-length(3), ...               |                 |
| `mlx-community/gemma-3n-E2B-4bit`                       |               821 |                   500 |          1,321 |      77.6 |           6 | length          |            7.26s |      1.50s |       9.13s | repetitive(phrase: "- do no...     |                 |
| `mlx-community/diffusiongemma-26B-A4B-it-mxfp8`         |               835 |                    96 |            931 |        15 |          28 | stop            |            7.55s |      3.41s |      11.37s | low-draft-improvement              |                 |
| `mlx-community/Phi-3.5-vision-instruct-bf16`            |             1,394 |                   130 |          1,524 |      19.1 |         9.5 | stop            |            7.84s |      0.98s |       9.22s | keyword-count(21), ...             |                 |
| `mlx-community/gemma-3n-E4B-it-bf16`                    |               829 |                   332 |          1,161 |      46.8 |          17 | stop            |            8.05s |      2.39s |      10.81s | description-sentences(10), ...     |                 |
| `mlx-community/gemma-3-27b-it-qat-8bit`                 |               830 |                   108 |            938 |      17.7 |          32 | stop            |            8.05s |      3.39s |      11.81s | keyword-count(19), ...             |                 |
| `jqlive/Kimi-VL-A3B-Thinking-2506-6bit`                 |             1,564 |                   500 |          2,064 |      66.7 |          18 | length          |            9.07s |      2.23s |      11.69s | generation_loop(degeneration), ... |                 |
| `mlx-community/Kimi-VL-A3B-Thinking-8bit`               |             1,564 |                   500 |          2,064 |      61.5 |          22 | length          |            9.71s |      2.55s |      12.63s | missing-sections(title+desc...     |                 |
| `mlx-community/Llama-3.2-11B-Vision-Instruct-8bit`      |               543 |                   148 |            691 |        19 |          15 | stop            |            9.93s |      1.74s |      12.03s | description-sentences(4), ...      |                 |
| `mlx-community/gemma-3-27b-it-qat-4bit`                 |               830 |                   105 |            935 |      18.9 |          18 | stop            |           10.17s |      2.54s |      13.13s | keyword-count(21), ...             |                 |
| `mlx-community/ERNIE-4.5-VL-28B-A3B-Thinking-bf16`      |             1,883 |                   500 |          2,383 |      57.4 |          60 | length          |           10.69s |      4.86s |      15.93s | missing-sections(title+desc...     |                 |
| `mlx-community/llava-v1.6-mistral-7b-8bit`              |             2,791 |                   500 |          3,291 |      59.9 |         9.7 | length          |           11.12s |      0.95s |      12.43s | keyword-count(27), ...             |                 |
| `mlx-community/paligemma2-3b-pt-896-4bit`               |             4,654 |                   500 |          5,154 |        50 |         4.6 | length          |           11.95s |      1.28s |      13.61s | repetitive(phrase: "- outpu...     |                 |
| `mlx-community/GLM-4.6V-Flash-mxfp4`                    |             6,592 |                   500 |          7,092 |        80 |         8.4 | length          |           13.72s |      5.15s |      21.21s | repetitive(phrase: "black h...     |                 |
| `mlx-community/GLM-4.6V-Flash-6bit`                     |             6,592 |                    96 |          6,688 |      15.2 |          11 | stop            |           15.44s |      1.71s |      17.55s | hallucination, ...                 |                 |
| `mlx-community/Apriel-1.5-15b-Thinker-6bit-MLX`         |             3,457 |                   500 |          3,957 |      38.8 |          15 | length          |           15.59s |      1.98s |      17.93s | generation_loop(numeric_loop), ... |                 |
| `mlx-community/GLM-4.6V-nvfp4`                          |             6,592 |                   112 |          6,704 |      32.7 |          78 | stop            |           15.63s |      5.85s |      21.86s | hallucination, ...                 |                 |
| `mlx-community/Molmo-7B-D-0924-bf16`                    |             1,749 |                   114 |          1,863 |      30.3 |          48 | stop            |           19.55s |      1.88s |      21.87s | keyword-count(20), ...             |                 |
| `mlx-community/Qwen3-VL-2B-Instruct-bf16`               |            16,779 |                   500 |         17,279 |      91.9 |         8.6 | length          |           21.00s |      0.86s |      22.25s | ⚠️harness(long_context), ...       |                 |
| `mlx-community/MolmoPoint-8B-fp16`                      |             3,377 |                   106 |          3,483 |      5.95 |          27 | stop            |           21.20s |      2.36s |      23.94s | keyword-count(19), ...             |                 |
| `mlx-community/Molmo-7B-D-0924-8bit`                    |             1,749 |                   114 |          1,863 |      50.9 |          41 | stop            |           21.69s |      4.42s |      28.52s | keyword-count(20), ...             |                 |
| `Qwen/Qwen3-VL-2B-Instruct`                             |            16,779 |                   500 |         17,279 |      92.5 |         8.6 | length          |           21.79s |      0.69s |      22.84s | ⚠️harness(long_context), ...       |                 |
| `mlx-community/paligemma2-3b-ft-docci-448-bf16`         |             1,582 |                   500 |          2,082 |      18.9 |          11 | length          |           27.52s |      1.61s |      29.49s | repetitive(phrase: "- do no...     |                 |
| `meta-llama/Llama-3.2-11B-Vision-Instruct`              |               544 |                   134 |            678 |      3.35 |          25 | stop            |           42.44s |      2.36s |      45.18s | missing-sections(title+desc...     |                 |
| `mlx-community/X-Reasoner-7B-8bit`                      |            16,790 |                    14 |         16,804 |      46.4 |          13 | stop            |           55.00s |      3.14s |      60.31s | ⚠️harness(long_context), ...       |                 |
| `mlx-community/Ornith-1.0-35B-bf16`                     |            16,808 |                   137 |         16,945 |      56.1 |          76 | stop            |           58.21s |      6.07s |      64.68s | title-length(11)                   |                 |
| `mlx-community/Qwen3.5-35B-A3B-6bit`                    |            16,808 |                   113 |         16,921 |      68.7 |          35 | stop            |           59.23s |      3.35s |      62.95s |                                    |                 |
| `mlx-community/Qwen3-VL-2B-Thinking-bf16`               |            16,781 |                   500 |         17,281 |      27.9 |         8.6 | length          |           66.78s |      0.97s |      68.35s | ⚠️harness(long_context), ...       |                 |
| `mlx-community/Qwen3.5-9B-MLX-4bit`                     |            16,808 |                    99 |         16,907 |      91.4 |          11 | stop            |           67.05s |      1.56s |      69.00s |                                    |                 |
| `mlx-community/Qwen3.5-35B-A3B-bf16`                    |            16,808 |                    93 |         16,901 |      59.7 |          76 | stop            |           68.07s |      6.62s |      75.08s | low-draft-improvement              |                 |
| `mlx-community/Qwen3.5-35B-A3B-4bit`                    |            16,808 |                   105 |         16,913 |      68.2 |          26 | stop            |           73.62s |      2.75s |      76.73s |                                    |                 |
| `mlx-community/Qwen2-VL-2B-Instruct-4bit`               |            16,790 |                   500 |         17,290 |       207 |         5.1 | length          |           79.52s |      2.45s |      82.62s | ⚠️harness(long_context), ...       |                 |
| `mlx-community/Qwen3.5-27B-mxfp8`                       |            16,808 |                   131 |         16,939 |      18.3 |          38 | stop            |           99.24s |      3.38s |     103.01s |                                    |                 |
| `mlx-community/Qwen3.5-27B-4bit`                        |            16,808 |                   121 |         16,929 |      23.9 |          26 | stop            |          100.84s |      2.85s |     106.12s |                                    |                 |
| `mlx-community/Kimi-VL-A3B-Thinking-2506-bf16`          |             1,564 |                   500 |          2,064 |      4.37 |          39 | length          |          118.17s |      3.57s |     122.12s | missing-sections(title), ...       |                 |
| `mlx-community/Qwen3.6-27B-mxfp8`                       |            16,808 |                   109 |         16,917 |      6.35 |          38 | stop            |          137.78s |      4.46s |     142.77s |                                    |                 |
...
Report generated on: 2026-07-13 05:57:30 BST
