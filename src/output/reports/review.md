...
| `mlx-community/Qwen3.5-9B-MLX-4bit`                 | `token_cap` | preserves trusted hints | hit token cap (200) \| nontext prompt burden=100% \| degeneration=repeated_punctuation: ':**...' |
| `mlx-community/Qwen3.5-35B-A3B-4bit`                | `token_cap` | preserves trusted hints | hit token cap (200) \| nontext prompt burden=100% \| degeneration=repeated_punctuation: ':**...' |
...
| `mlx-community/Qwen2-VL-2B-Instruct-4bit`          | `context_budget` | preserves trusted hints | Output appears truncated to about 9 tokens. \| At long prompt length (16250 tokens), output stayed unusually short (9 tokens; ratio 0.1%). \| output/prompt=0.06% \| nontext prompt burden=100% |
