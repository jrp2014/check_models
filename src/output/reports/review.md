...
| `mlx-community/Molmo-7B-D-0924-8bit`                    | `model_shortcoming` | improves trusted hints                                                                                    | nontext prompt burden=70% \| missing sections: title, description, keywords \| missing terms: classic, style, hull, wooden, mast                                                                                            |
