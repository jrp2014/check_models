...
- `mlx-community/Qwen3-VL-2B-Instruct-bf16`: caption-review candidate | 134.8 tps
- `Qwen/Qwen3-VL-2B-Instruct`: caption-review candidate | 134.3 tps
- `mlx-community/Qwen3.5-35B-A3B-6bit`: caption-review candidate | 98.5 tps
- `mlx-community/GLM-4.6V-nvfp4`: caption-review candidate | 49.9 tps
- `mlx-community/paligemma2-10b-ft-docci-448-6bit`: caption-review candidate | 34.9 tps

### Watchlist

- `mlx-community/paligemma2-3b-pt-896-4bit`: caption-review candidate | 82.3 tps | harness, long context
- `mlx-community/Qwen3-VL-2B-Thinking-bf16`: caption-review candidate | 135.0 tps | harness, text sanity
- `mlx-community/MiniCPM-V-4.6-8bit`: caption-review candidate | 258.6 tps | Output lacks detail
- `mlx-community/Idefics3-8B-Llama3-bf16`: caption-review candidate | 34.2 tps | Keywords are not specific or diverse enough
- `mlx-community/LFM2.5-VL-1.6B-bf16`: caption-review candidate | 187.8 tps | Output lacks detail
...
| Model                                              | Verdict           | Hint Handling   | Key Evidence                                                                                           |
|----------------------------------------------------|-------------------|-----------------|--------------------------------------------------------------------------------------------------------|
| `mlx-community/FastVLM-0.5B-bf16`                  | `runtime_failure` | not evaluated   | model error \| mlx vlm model load model                                                                |
| `mlx-community/GLM-4.6V-Flash-6bit`                | `runtime_failure` | not evaluated   | model error \| mlx vlm model load model                                                                |
| `mlx-community/Qwen3.5-9B-MLX-4bit`                | `runtime_failure` | not evaluated   | model error \| mlx vlm model load model                                                                |
| `mlx-community/Qwen3.6-27B-mxfp8`                  | `runtime_failure` | not evaluated   | model error \| mlx vlm model load model                                                                |
| `mlx-community/SmolVLM-Instruct-bf16`              | `runtime_failure` | not evaluated   | model error \| mlx vlm model load model                                                                |
| `mlx-community/SmolVLM2-2.2B-Instruct-mlx`         | `runtime_failure` | not evaluated   | model error \| mlx vlm model load model                                                                |
