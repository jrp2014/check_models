...
- Usability: usable 12, usable with caveats 13, unusable 16, not evaluated 1
- Top observations: Required fields are missing or empty (15), Title or keywords do not meet requested constraints (13), Response appears cut off at the token limit (8), Extra text appears before the Title field (6), Internal reasoning block appears incomplete (3)
