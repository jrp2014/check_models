...
- *Run timestamp:* 2026-08-28 20:07:01 BST
...
differ in: prompt differs; image differs (sha256 4d57e07687c4… →
dadec238f988…). Treat any difference against this baseline as a change of
inputs, not a change of model or runtime behaviour.

- *Baseline:* 16c1d866:src/output/results.jsonl
- *Baseline run timestamp:* 2026-08-24 23:59:43 BST
- *Baseline check_models:* 0.14.1 @ 93a90d917
- *Baseline mlx:* 0.32.2.dev20260824+43d2f06cb @ 43d2f06cb
- *Baseline mlx-vlm:* 0.6.16 @ 2b31570bd
...
| --- | --- | --- | --- | --- | --- |
| LiquidAI/LFM2.5-VL-450M-MLX-bf16 | usable | 1.60s | 481 tok/s | 1.9 | none |
| mlx-community/Devstral-Small-2-24B-Instruct-2512-5bit | usable | 10.95s | 29.4 tok/s | 23 | none |
| mlx-community/gemma-3-27b-it-qat-4bit | usable | 8.77s | 31.3 tok/s | 17 | none |
| mlx-community/gemma-4-26b-a4b-it-4bit | usable | 4.18s | 129 tok/s | 16 | none |
| mlx-community/gemma-4-31b-it-4bit | usable | 7.88s | 26.4 tok/s | 20 | none |
| mlx-community/granite-4.0-3b-vision-4bit | usable | 2.88s | 171 tok/s | 4.6 | none |
| mlx-community/Idefics3-8B-Llama3-bf16 | usable | 8.59s | 34.0 tok/s | 18 | none |
| mlx-community/Ministral-3-14B-Instruct-2512-mxfp4 | usable | 5.82s | 67.6 tok/s | 13 | none |
| mlx-community/Ministral-3-3B-Instruct-2512-4bit | usable | 3.21s | 190 tok/s | 7.8 | none |
| mlx-community/Molmo2-8B-4bit | usable | 5.50s | 72.5 tok/s | 8.8 | none |
| mlx-community/Qwen3-VL-30B-A3B-Instruct-4bit | usable | 59.53s | 87.1 tok/s | 23 | none |
| mlx-community/Qwen3.5-35B-A3B-4bit | usable | 56.24s | 110 tok/s | 24 | none |
| mlx-community/diffusiongemma-26B-A4B-it-8bit | usable with caveats | 6.48s | 53.4 tok/s | 29 | control tokens visible |
| mlx-community/diffusiongemma-26B-A4B-it-mxfp8 | usable with caveats | 6.00s | 60.4 tok/s | 28 | control tokens visible |
| mlx-community/GLM-4.6V-Flash-mxfp4 | usable with caveats | 9.72s | 79.6 tok/s | 8.4 | title/keyword constraints failed |
| mlx-community/GLM-4.6V-nvfp4 | usable with caveats | 29.24s | 41.5 tok/s | 78 | control tokens visible |
| mlx-community/InternVL3-8B-bf16 | usable with caveats | 6.30s | 36.5 tok/s | 17 | title/keyword constraints failed |
| mlx-community/Kimi-VL-A3B-Thinking-2506-bf16 | usable with caveats | 150.24s | 4.73 tok/s | 40 | role tokens visible |
| mlx-community/Ministral-3-14B-Instruct-2512-nvfp4 | usable with caveats | 6.45s | 64.8 tok/s | 13 | title/keyword constraints failed |
| mlx-community/North-Micro-Vision-Instruct-4bit | usable with caveats | 5.61s | 230 tok/s | 3.9 | title/keyword constraints failed |
| mlx-community/Ornith-1.0-35B-bf16 | usable with caveats | 66.45s | 64.2 tok/s | 74 | title/keyword constraints failed; draft hints copied unchanged |
| mlx-community/Phi-3.5-vision-instruct-bf16 | usable with caveats | 4.40s | 56.3 tok/s | 9.4 | title/keyword constraints failed |
| mlx-community/pixtral-12b-8bit | usable with caveats | 6.96s | 39.4 tok/s | 16 | title/keyword constraints failed |
| mlx-community/Qwen3-VL-2B-Thinking-bf16 | usable with caveats | 27.70s | 90.3 tok/s | 8.4 | title/keyword constraints failed |
| mlx-community/Qwen3.5-9B-MLX-4bit | usable with caveats | 65.40s | 89.0 tok/s | 10.0 | title/keyword constraints failed |
| mlx-community/Qwen3.6-27B-mxfp8 | usable with caveats | 98.20s | 17.2 tok/s | 33 | title/keyword constraints failed |
| mlx-community/Qwen3.8-27B-4bit | usable with caveats | 83.60s | 29.5 tok/s | 21 | title/keyword constraints failed |
| mlx-community/SmolVLM2-2.2B-Instruct-mlx | usable with caveats | 2.67s | 123 tok/s | 5.5 | title/keyword constraints failed; draft hints copied unchanged |
| mlx-community/Step-3.7-Flash-oQ2e | usable with caveats | 38.45s | 18.8 tok/s | 70 | title/keyword constraints failed; draft hints copied unchanged |
| Qwen/Qwen3-VL-2B-Instruct | usable with caveats | 15.97s | 93.4 tok/s | 8.4 | title/keyword constraints failed |
| jinaai/jina-vlm-mlx | unusable | 10.15s | 133 tok/s | 3.7 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/Apriel-1.5-15b-Thinker-6bit-MLX | unusable | 28.43s | 41.3 tok/s | 15 | missing required fields; echoes instructions; cut off at token limit |
| mlx-community/ERNIE-4.5-VL-28B-A3B-Thinking-bf16 | unusable | 33.20s | 50.9 tok/s | 60 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/FastVLM-0.5B-bf16 | unusable | 2.18s | 344 tok/s | 2.1 | missing required fields |
| mlx-community/gemma-3n-E4B-it-bf16 | unusable | 7.10s | 48.7 tok/s | 17 | missing required fields |
| mlx-community/GLM-4.1V-9B-Thinking-8bit | unusable | 29.14s | 47.0 tok/s | 13 | repeated text; extra text before Title; cut off at token limit; incomplete thinking block; title/keyword constraints failed |
| mlx-community/LFM2.5-VL-1.6B-bf16 | unusable | 6.86s | 186 tok/s | 4.0 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/MiniCPM-V-4.6-8bit | unusable | 2.03s | 275 tok/s | 3.8 | missing required fields; extra text before Title |
| mlx-community/X-Reasoner-7B-8bit | unusable | 38.23s | 55.8 tok/s | 13 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/LFM2.5-VL-3B-OptiQ-4bit | not evaluated | 0.21s | - | - | crashed during model_load |
| tencent/Youtu-VL-4B-Instruct | not evaluated | 1.01s | - | - | crashed during model_load |
...
| --- | --- | --- | --- |
| jinaai/jina-vlm-mlx | unusable | Response repeats the same text; Response appears cut off at the token limit; Title has 4 words (requested 5-10); Keyword list has 380 terms (requested 10-18); Duplicate keywords: boathouse, pond, foliage, tree, deck, railing, rustic, outdoor, serene, nature, birdwatching, pondside | [diagnostics](https://github.com/jrp2014/check_models/blob/main/src/output/reports/diagnostics.md#diagnostic-jinaai-jina-vlm-mlx) |
| mlx-community/ERNIE-4.5-VL-28B-A3B-Thinking-bf16 | unusable | Response repeats the same text; Response appears cut off at the token limit; Keyword list has 158 terms (requested 10-18); Duplicate keywords: boardwalk | [diagnostics](https://github.com/jrp2014/check_models/blob/main/src/output/reports/diagnostics.md#diagnostic-mlx-community-ernie-45-vl-28b-a3b-thinking-bf16) |
...
| mlx-community/LFM2.5-VL-1.6B-bf16 | unusable | Response repeats the same text; Response appears cut off at the token limit; Keyword list has 395 terms (requested 10-18); Duplicate keywords: elevated, wetland, pond, outdoor, railings, reflection, natural, environment, architecture, birdwatching, peaceful, serene | [diagnostics](https://github.com/jrp2014/check_models/blob/main/src/output/reports/diagnostics.md#diagnostic-mlx-community-lfm25-vl-16b-bf16) |
| mlx-community/X-Reasoner-7B-8bit | unusable | Response repeats the same text; Response appears cut off at the token limit; Keyword list has 436 terms (requested 10-18); Duplicate keywords: pond, wetland, grass, reeds, trees, architecture, moss, weathered, landscape, outdoor, nature, structure, environment, ecosystem, habitat, accurate, precise, detailed, comprehensive, thorough | [diagnostics](https://github.com/jrp2014/check_models/blob/main/src/output/reports/diagnostics.md#diagnostic-mlx-community-x-reasoner-7b-8bit) |
...
- *check_models revision:* 16c1d866344fffe1a27a511e7aa8100161a61810
