...
- *Run timestamp:* 2026-08-02 00:27:38 BST
...
- *Other results requiring review:* 26
...
35 clean completions; see the [full model gallery](https://github.com/jrp2014/check_models/blob/main/src/output/reports/model_gallery.md).
