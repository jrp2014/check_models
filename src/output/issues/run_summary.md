...
- *Run timestamp:* 2026-08-24 23:59:43 BST
...
- *Baseline:* 93a90d91:src/output/results.jsonl
- *Baseline run timestamp:* 2026-08-23 23:10:25 BST
- *Baseline check_models:* 0.14.1 @ 6f54a4fe2
- *Baseline mlx:* 0.32.2.dev20260823+451dc8759 @ 451dc8759
- *Baseline mlx-vlm:* 0.6.16 @ 5fa03cfcc
- *Baseline transformers:* 5.15.1
- *Baseline python:* 3.14.7
- *Models compared:* 42
- *Identical generated text:* 40 of 42 completed in both
- *Generation tok/s ratio (now/baseline):* 1.012 (range 0.89-1.33, 42 models)
- *Throughput noise band:* history (last 9 same-prompt runs, Tukey fence, at
...
| mlx-community/diffusiongemma-26B-A4B-it-8bit | completed | usable_with_caveats | -catalog_constraint_violation |

| Model | Baseline tok/s | Now tok/s | Ratio | Expected band |
| --- | --- | --- | --- | --- |
| mlx-community/gemma-3-27b-it-qat-4bit | 26.4 | 27.7 | 1.05 | 27.9-34.1 (history, n=9) |
...
| --- | --- | --- | --- | --- | --- |
| LiquidAI/LFM2.5-VL-450M-MLX-bf16 | usable | 2.09s | 481 tok/s | 1.9 | none |
| mlx-community/Devstral-Small-2-24B-Instruct-2512-5bit | usable | 11.04s | 29.7 tok/s | 24 | none |
| mlx-community/gemma-4-26b-a4b-it-4bit | usable | 4.35s | 126 tok/s | 16 | none |
| mlx-community/gemma-4-31b-it-4bit | usable | 9.14s | 24.9 tok/s | 20 | none |
| mlx-community/Idefics3-8B-Llama3-bf16 | usable | 9.75s | 34.2 tok/s | 18 | none |
| mlx-community/LFM2.5-VL-1.6B-bf16 | usable | 2.28s | 192 tok/s | 4.0 | none |
| mlx-community/Ministral-3-14B-Instruct-2512-mxfp4 | usable | 6.62s | 66.3 tok/s | 14 | none |
| mlx-community/Ministral-3-3B-Instruct-2512-4bit | usable | 3.51s | 184 tok/s | 9.0 | none |
| mlx-community/Ornith-1.0-35B-bf16 | usable | 75.27s | 63.9 tok/s | 74 | none |
| mlx-community/pixtral-12b-8bit | usable | 7.37s | 39.3 tok/s | 16 | none |
| mlx-community/Qwen3.5-35B-A3B-4bit | usable | 69.17s | 96.4 tok/s | 24 | none |
| mlx-community/Qwen3.5-9B-MLX-4bit | usable | 70.79s | 90.9 tok/s | 10.0 | none |
| mlx-community/Qwen3.8-27B-4bit | usable | 91.08s | 27.7 tok/s | 21 | none |
| mlx-community/SmolVLM2-2.2B-Instruct-mlx | usable | 2.59s | 126 tok/s | 5.5 | none |
| mlx-community/Step-3.7-Flash-oQ2e | usable | 28.91s | 44.2 tok/s | 70 | none |
| mlx-community/diffusiongemma-26B-A4B-it-8bit | usable with caveats | 6.14s | 64.8 tok/s | 29 | control tokens visible |
| mlx-community/diffusiongemma-26B-A4B-it-mxfp8 | usable with caveats | 5.68s | 67.1 tok/s | 28 | control tokens visible; title/keyword constraints failed |
| mlx-community/gemma-3-27b-it-qat-4bit | usable with caveats | 9.26s | 27.7 tok/s | 17 | title/keyword constraints failed |
| mlx-community/GLM-4.6V-nvfp4 | usable with caveats | 29.45s | 40.7 tok/s | 78 | control tokens visible; title/keyword constraints failed |
| mlx-community/InternVL3-8B-bf16 | usable with caveats | 6.48s | 36.0 tok/s | 17 | title/keyword constraints failed |
| mlx-community/Kimi-VL-A3B-Thinking-2506-bf16 | usable with caveats | 133.22s | 4.8 tok/s | 40 | role tokens visible |
| mlx-community/MiniCPM-V-4.6-8bit | usable with caveats | 2.29s | 266 tok/s | 3.8 | title/keyword constraints failed |
| mlx-community/Ministral-3-14B-Instruct-2512-nvfp4 | usable with caveats | 7.29s | 63.2 tok/s | 15 | title/keyword constraints failed |
| mlx-community/Molmo-7B-D-0924-8bit | usable with caveats | 5.44s | 52.9 tok/s | 11 | title/keyword constraints failed |
| mlx-community/Phi-3.5-vision-instruct-bf16 | usable with caveats | 3.42s | 57.1 tok/s | 9.6 | title/keyword constraints failed |
| mlx-community/Qwen3-VL-2B-Thinking-bf16 | usable with caveats | 33.82s | 89.1 tok/s | 8.4 | title/keyword constraints failed |
| mlx-community/Qwen3.6-27B-mxfp8 | usable with caveats | 98.06s | 16.3 tok/s | 33 | title/keyword constraints failed |
| mlx-community/X-Reasoner-7B-8bit | usable with caveats | 26.69s | 54.1 tok/s | 13 | title/keyword constraints failed |
| mlx-community/Apriel-1.5-15b-Thinker-6bit-MLX | unusable | 29.18s | 40.8 tok/s | 15 | echoes instructions; extra text before Title; cut off at token limit; title/keyword constraints failed |
| mlx-community/ERNIE-4.5-VL-28B-A3B-Thinking-bf16 | unusable | 29.01s | 56.1 tok/s | 60 | cut off at token limit; title/keyword constraints failed |
| mlx-community/FastVLM-0.5B-bf16 | unusable | 2.40s | 353 tok/s | 2.1 | missing required fields; echoes instructions; extra text before Title |
| mlx-community/gemma-3n-E4B-it-bf16 | unusable | 7.31s | 47.9 tok/s | 17 | missing required fields |
| mlx-community/GLM-4.1V-9B-Thinking-8bit | unusable | 32.32s | 44.5 tok/s | 13 | missing required fields; extra text before Title |
| mlx-community/GLM-4.6V-Flash-mxfp4 | unusable | 22.69s | 74.2 tok/s | 8.4 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/Llama-3.2-11B-Vision-Instruct-8bit | unusable | 57.08s | 18.8 tok/s | 15 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/llava-v1.6-mistral-7b-8bit | unusable | 4.64s | 64.8 tok/s | 9.7 | missing required fields |
| mlx-community/MolmoPoint-8B-fp16 | unusable | 27.90s | 6.49 tok/s | 24 | missing required fields |
| mlx-community/nanoLLaVA-1.5-4bit | unusable | 1.70s | 300 tok/s | 2.3 | missing required fields; echoes instructions |
| mlx-community/paligemma2-3b-pt-896-4bit | unusable | 25.70s | 44.8 tok/s | 4.4 | repeated text; missing required fields; echoes instructions; cut off at token limit |
| mlx-community/Qwen2-VL-2B-Instruct-4bit | unusable | 77.46s | 216 tok/s | 5.1 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/Qwen3-VL-2B-Instruct-bf16 | unusable | 33.81s | 88.6 tok/s | 8.4 | repeated text; cut off at token limit; title/keyword constraints failed |
| Qwen/Qwen3-VL-2B-Instruct | unusable | 27.27s | 90.7 tok/s | 8.4 | repeated text; cut off at token limit; title/keyword constraints failed |
...
| mlx-community/diffusiongemma-26B-A4B-it-mxfp8 | usable with caveats | Unrecognised model control tokens remain visible; Duplicate keywords: memorial | [diagnostics](https://github.com/jrp2014/check_models/blob/main/src/output/reports/diagnostics.md#diagnostic-mlx-community-diffusiongemma-26b-a4b-it-mxfp8) |
...
- *check_models revision:* 93a90d917d3ef80a0f0298d364a316b737266f92
