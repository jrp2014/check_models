...
- *Run timestamp:* 2026-08-23 12:44:16 BST
...
| --- | --- | --- | --- | --- | --- |
| LiquidAI/LFM2.5-VL-450M-MLX-bf16 | usable | 2.10s | 491 tok/s | 1.9 | none |
| mlx-community/Devstral-Small-2-24B-Instruct-2512-5bit | usable | 11.81s | 28.6 tok/s | 24 | none |
| mlx-community/gemma-4-26b-a4b-it-4bit | usable | 4.81s | 102 tok/s | 16 | none |
| mlx-community/gemma-4-31b-it-4bit | usable | 9.07s | 25.9 tok/s | 20 | none |
| mlx-community/Idefics3-8B-Llama3-bf16 | usable | 10.52s | 32.5 tok/s | 18 | none |
| mlx-community/LFM2.5-VL-1.6B-bf16 | usable | 2.39s | 186 tok/s | 4.0 | none |
| mlx-community/Ministral-3-14B-Instruct-2512-mxfp4 | usable | 7.22s | 63.6 tok/s | 14 | none |
| mlx-community/Ministral-3-3B-Instruct-2512-4bit | usable | 3.89s | 181 tok/s | 9.0 | none |
| mlx-community/Ornith-1.0-35B-bf16 | usable | 76.38s | 59.5 tok/s | 74 | none |
| mlx-community/pixtral-12b-8bit | usable | 12.84s | 35.1 tok/s | 16 | none |
| mlx-community/Qwen3.5-35B-A3B-4bit | usable | 66.13s | 69.7 tok/s | 24 | none |
| mlx-community/Qwen3.5-9B-MLX-4bit | usable | 66.43s | 89.4 tok/s | 10.0 | none |
| mlx-community/Qwen3.8-27B-4bit | usable | 85.19s | 29.3 tok/s | 21 | none |
| mlx-community/SmolVLM2-2.2B-Instruct-mlx | usable | 2.68s | 123 tok/s | 5.5 | none |
| mlx-community/Step-3.7-Flash-oQ2e | usable | 24.84s | 42.5 tok/s | 70 | none |
| mlx-community/diffusiongemma-26B-A4B-it-8bit | usable with caveats | 6.88s | 49.9 tok/s | 29 | control tokens visible; title/keyword constraints failed |
| mlx-community/diffusiongemma-26B-A4B-it-mxfp8 | usable with caveats | 6.57s | 47.3 tok/s | 28 | control tokens visible; title/keyword constraints failed |
| mlx-community/gemma-3-27b-it-qat-4bit | usable with caveats | 8.95s | 30.0 tok/s | 17 | title/keyword constraints failed |
| mlx-community/GLM-4.6V-nvfp4 | usable with caveats | 27.23s | 38.5 tok/s | 78 | control tokens visible; title/keyword constraints failed |
| mlx-community/InternVL3-8B-bf16 | usable with caveats | 6.72s | 34.5 tok/s | 17 | title/keyword constraints failed |
| mlx-community/Kimi-VL-A3B-Thinking-2506-bf16 | usable with caveats | 138.49s | 4.61 tok/s | 40 | role tokens visible |
| mlx-community/MiniCPM-V-4.6-8bit | usable with caveats | 2.66s | 184 tok/s | 3.8 | title/keyword constraints failed |
| mlx-community/Ministral-3-14B-Instruct-2512-nvfp4 | usable with caveats | 7.63s | 61.5 tok/s | 15 | title/keyword constraints failed |
| mlx-community/Molmo-7B-D-0924-8bit | usable with caveats | 5.78s | 50.4 tok/s | 11 | title/keyword constraints failed |
| mlx-community/Phi-3.5-vision-instruct-bf16 | usable with caveats | 3.58s | 53.6 tok/s | 9.6 | title/keyword constraints failed |
| mlx-community/Qwen3-VL-2B-Thinking-bf16 | usable with caveats | 27.29s | 89.4 tok/s | 8.4 | title/keyword constraints failed |
| mlx-community/Qwen3.6-27B-mxfp8 | usable with caveats | 89.81s | 17.8 tok/s | 33 | title/keyword constraints failed |
| mlx-community/X-Reasoner-7B-8bit | usable with caveats | 24.83s | 56.4 tok/s | 13 | title/keyword constraints failed |
| mlx-community/Apriel-1.5-15b-Thinker-6bit-MLX | unusable | 30.24s | 39.9 tok/s | 15 | echoes instructions; extra text before Title; cut off at token limit; title/keyword constraints failed |
| mlx-community/ERNIE-4.5-VL-28B-A3B-Thinking-bf16 | unusable | 26.85s | 53.1 tok/s | 60 | cut off at token limit; title/keyword constraints failed |
| mlx-community/FastVLM-0.5B-bf16 | unusable | 2.51s | 287 tok/s | 2.1 | missing required fields; echoes instructions; extra text before Title |
| mlx-community/gemma-3n-E4B-it-bf16 | unusable | 8.00s | 43.6 tok/s | 17 | missing required fields |
| mlx-community/GLM-4.1V-9B-Thinking-8bit | unusable | 33.29s | 43.6 tok/s | 13 | missing required fields; extra text before Title |
| mlx-community/GLM-4.6V-Flash-mxfp4 | unusable | 22.95s | 72.6 tok/s | 8.4 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/Llama-3.2-11B-Vision-Instruct-8bit | unusable | 55.49s | 19.4 tok/s | 15 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/llava-v1.6-mistral-7b-8bit | unusable | 4.44s | 63.9 tok/s | 9.7 | missing required fields |
| mlx-community/MolmoPoint-8B-fp16 | unusable | 29.82s | 6.18 tok/s | 24 | missing required fields |
| mlx-community/nanoLLaVA-1.5-4bit | unusable | 2.12s | 179 tok/s | 2.3 | missing required fields; echoes instructions |
| mlx-community/paligemma2-3b-pt-896-4bit | unusable | 27.12s | 43.2 tok/s | 4.4 | repeated text; missing required fields; echoes instructions; cut off at token limit |
| mlx-community/Qwen2-VL-2B-Instruct-4bit | unusable | 78.32s | 212 tok/s | 5.1 | repeated text; cut off at token limit; title/keyword constraints failed |
| mlx-community/Qwen3-VL-2B-Instruct-bf16 | unusable | 27.91s | 89.4 tok/s | 8.4 | repeated text; cut off at token limit; title/keyword constraints failed |
| Qwen/Qwen3-VL-2B-Instruct | unusable | 26.97s | 91.8 tok/s | 8.4 | repeated text; cut off at token limit; title/keyword constraints failed |
...
| mlx-community/diffusiongemma-26B-A4B-it-mxfp8 | usable with caveats | Unrecognised model control tokens remain visible; Duplicate keywords: memorial, sculpture | [diagnostics](https://github.com/jrp2014/check_models/blob/main/src/output/reports/diagnostics.md#diagnostic-mlx-community-diffusiongemma-26b-a4b-it-mxfp8) |
...
- *check_models revision:* d717f91bfd18f367a808c62c9ba03e2661ab11bc
