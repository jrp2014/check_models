...
|--------------------------------------|------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `mlx-community/Qwen3.5-35B-A3B-bf16` | Output degeneration under long prompt length (incomplete_sentence: ends with 'of') | prompt=16,639 \| output/prompt=3.00% \| nontext burden=98% \| stop=max_tokens \| hit token cap (500) | [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260606T195124Z_006_mlx-community_Qwen3.5-35B-A3B-bf16_mlx_vlm_mlx_long_context_002.json) |
<!-- markdownlint-enable MD060 -->


## Minimal Evidence

- `mlx-community/Qwen3.5-35B-A3B-bf16`: Output degeneration under long prompt length (incomplete_sentence: ends with 'of')
- Output excerpt: `The user wants me to generate cataloguing metadata for the provided image. I need to follow specific rules: - British English. - Only clearly visible details. - Three sections: Title, Description, Keywords. - Specific constraints for each section (word counts, formatting). - Ignore the "metadata hints" about the dat...`
...
```bash
python -m mlx_vlm.generate --model mlx-community/Qwen3.5-35B-A3B-bf16 --image /Users/jrp/Pictures/Processed/20260525-164635_DSC00024.jpg --prompt 'Analyze this image for cataloguing metadata, using British English.
...
- `mlx-community/Qwen3.5-35B-A3B-bf16`: [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260606T195124Z_006_mlx-community_Qwen3.5-35B-A3B-bf16_mlx_vlm_mlx_long_context_002.json)
...
- Three sections: Title, Description,...
```
