...
- **Primary model:** `mlx-community/Devstral-Small-2-24B-Instruct-2512-5bit`
...
- Tokenizer decode leaked BPE/byte markers
- Representative signal: 76 BPE space markers found in decoded text
