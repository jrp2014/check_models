...
|-------------------------------------------|----------------------------------------|----------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `Qwen/Qwen3-VL-2B-Instruct`               | prompt_tokens=16822, repetitive output | prompt=16,822 \| output/prompt=2.97% \| mixed burden=97% \| stop=max_tokens \| hit token cap (500) | [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_005_Qwen_Qwen3-VL-2B-Instruct_mlx_vlm_mlx_long_context_001.json)               |
| `mlx-community/Qwen3-VL-2B-Instruct-bf16` | prompt_tokens=16822, repetitive output | prompt=16,822 \| output/prompt=2.97% \| mixed burden=97% \| stop=max_tokens \| hit token cap (500) | [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_006_mlx-community_Qwen3-VL-2B-Instruct-bf16_mlx_vlm_mlx_long_context_001.json) |
| `mlx-community/Qwen3-VL-2B-Thinking-bf16` | prompt_tokens=16824, repetitive output | prompt=16,824 \| output/prompt=2.97% \| mixed burden=97% \| stop=max_tokens \| hit token cap (500) | [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_007_mlx-community_Qwen3-VL-2B-Thinking-bf16_mlx_vlm_mlx_long_context_001.json) |
| `mlx-community/X-Reasoner-7B-8bit`        | prompt_tokens=16833, repetitive output | prompt=16,833 \| output/prompt=2.97% \| mixed burden=97% \| stop=max_tokens \| hit token cap (500) | [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_008_mlx-community_X-Reasoner-7B-8bit_mlx_vlm_mlx_long_context_001.json)        |
<!-- markdownlint-enable MD060 -->


## Minimal Evidence

- `Qwen/Qwen3-VL-2B-Instruct`: At long prompt length (16822 tokens), output became repetitive.
- `Qwen/Qwen3-VL-2B-Instruct`: Model output may not follow prompt or image contents (missing: Architecture, Building, Buildings, Cars, City).
- Output excerpt: `- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -...`
- `mlx-community/Qwen3-VL-2B-Instruct-bf16`: At long prompt length (16822 tokens), output became repetitive.
...
- `Qwen/Qwen3-VL-2B-Instruct`: [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_005_Qwen_Qwen3-VL-2B-Instruct_mlx_vlm_mlx_long_context_001.json)
- `mlx-community/Qwen3-VL-2B-Instruct-bf16`: [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_006_mlx-community_Qwen3-VL-2B-Instruct-bf16_mlx_vlm_mlx_long_context_001.json)
- `mlx-community/Qwen3-VL-2B-Thinking-bf16`: [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_007_mlx-community_Qwen3-VL-2B-Thinking-bf16_mlx_vlm_mlx_long_context_001.json)
- `mlx-community/X-Reasoner-7B-8bit`: [optional JSON](https://github.com/jrp2014/check_models/blob/main/src/output/repro_bundles/20260719T014155Z_008_mlx-community_X-Reasoner-7B-8bit_mlx_vlm_mlx_long_context_001.json)
...
- At long prompt length (16822 tokens), output became repetitive.
- Model output may not follow prompt or image contents (missing: Architecture, Building, Buildings, Cars, City).
...
- At long prompt length (16824 tokens), output became repetitive.
- Model output may not follow prompt or image contents (missing: Architecture, Building, Buildings, Cars, City).
- Output became repetitive, indicating possible generation instability (token: -).
- Output contains corrupted or malformed text segments (character_loop: ' -' repeated).
- Output omitted required Title/Description/Keywords sections (title, description, keywords).
