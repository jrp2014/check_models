...
class Attention(nn.Module):
    ...
    v_proj: Incomplete
    out_proj: Incomplete
    def __init__(self, dims: int, num_heads: int, query_input_dims: int | None = None, key_input_dims: int | None = None, value_input_dims: int | None = None, value_dims: int | None = None, value_output_dims: int | None = None) -> None: ...
...
class VisionModel(nn.Module):
    ...
    def __init__(self, config: VisionConfig) -> None: ...
    def __call__(self, x: mx.array, patch_attention_mask: mx.array | None = None, output_hidden_states: bool | None = None) -> mx.array: ...
