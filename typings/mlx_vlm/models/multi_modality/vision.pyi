...
from .sam import SAMEncoder as SAMEncoder
...
class Attention(nn.Module):
    ...
    qkv: Incomplete
    proj: Incomplete
    def __init__(self, dims: int, num_heads: int, qkv_bias: bool = False) -> None: ...
...
class HybridVisionModel(nn.Module):
    ...
    def __init__(self, config: VisionConfig, resolution: str, ignore_head: bool = True) -> None: ...
    def __call__(self, x: mx.array) -> mx.array: ...

def resize_image(image, size, antialias: bool = True): ...

class VisionModel(nn.Module):
    model_type: Incomplete
    config: Incomplete
    high_layer_norm: Incomplete
    low_layer_norm: Incomplete
    vision_tower_high: Incomplete
    vision_tower_low: Incomplete
    low_res_size: Incomplete
    resize: Incomplete
    vision_tower: Incomplete
