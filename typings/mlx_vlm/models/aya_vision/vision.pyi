...
class VisionEmbeddings(nn.Module):
    ...
    def __call__(self, x: mx.array, spatial_shapes: mx.array | None = None) -> mx.array: ...
...
class SigLipVisionModel(nn.Module):
    ...
    def __init__(self, config: VisionConfig) -> None: ...
    def __call__(self, x: mx.array, spatial_shapes: mx.array, output_hidden_states: bool | None = None) -> mx.array: ...

class VisionModel(nn.Module):
    model_type: Incomplete
    vision_model: Incomplete
    def __init__(self, config: VisionConfig) -> None: ...
    def __call__(self, x: mx.array, spatial_shapes: mx.array | None = None, output_hidden_states: bool | None = None) -> mx.array: ...
