...
def load_processor(model_path, add_detokenizer: bool = True, eos_token_ids: int | list[int] | None = None, **kwargs) -> PreTrainedTokenizer | PreTrainedTokenizerFast: ...
...
class StoppingCriteria:
    ...
    def add_eos_token_ids(self, new_eos_token_ids: int | list[int] | None = None): ...
    def reset(self, eos_token_ids: list[int] | None = None): ...
