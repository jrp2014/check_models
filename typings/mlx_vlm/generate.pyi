...
def stream_generate(model: nn.Module, processor: PreTrainedTokenizer, prompt: str, image: str | list[str] | None = None, audio: str | list[str] | None = None, **kwargs) -> str | Generator[str, None, None]: ...
def generate(model: nn.Module, processor: PreTrainedTokenizer, prompt: str, image: str | list[str] | None = None, audio: str | list[str] | None = None, verbose: bool = False, **kwargs) -> GenerationResult: ...
def main() -> None: ...
